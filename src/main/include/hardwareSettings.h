...
class hardwareSettings {
	...
	hardwareSettings() {
        ...
        encoderTurn.sensorDirection = true;
        ...
        motorTurn.peakOutputForward = 0.20F;
        motorTurn.peakOutputReverse = -0.20F;
        motorTurn.nominalOutputForward = 0.18F;
        motorTurn.nominalOutputReverse = -0.18F;
        ...
        motorTurn.slot0.kP = 0.0051;
        motorTurn.slot0.kI = 0;
        motorTurn.slot0.kD = 1.25;
